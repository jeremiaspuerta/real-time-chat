...
export const SignUpForm = ({handleSignUp}:Props) => {
    ...
    return (
        ...
        <form style={{display: 'flex',flexDirection: 'column',gap:'2vh'}} onSubmit={handleSubmit(onSubmit)}>
            <div>
                ...
                {errors.name && <p style={{color: 'red', marginTop: '.5vh'}}>This field is required</p>}
            </div>
            <div>
                ...
                {errors.email && <p style={{color: 'red', marginTop: '.5vh'}}>This field is required</p>}
            </div>
            <div>
                ...
                {errors.password && <p style={{color: 'red', marginTop: '.5vh'}}>This field is required</p>}
            </div>
